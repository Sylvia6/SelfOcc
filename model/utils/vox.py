...
from . import geom, basic

class Vox_util(object):
    def __init__(self, Z, Y, X, bounds, scene_centroid=[[0,0,0]], pad=None, assert_cube=False):
    ...
    def unproject_image_to_mem(self, rgb_camB, pixB_T_camA, camB_T_camA, Z=None, Y=None, X=None, assert_cube=False, xyz_camA=None):
